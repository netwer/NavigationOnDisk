/*
  ...
  <Application.Resources>
      <vm:ViewModelLocator xmlns:vm="clr-namespace:NavigationOnDiskProject"
                           x:Key="Locator" />
  </Application.Resources>
...
namespace NavigationOnDiskProject.ViewModel
{
    ...
    public class ViewModelLocator
    {
        ...
        public static NavigationOnDiskViewModel NavigationOnDisk
        {
            get { return ServiceLocator.Current.GetInstance<NavigationOnDiskViewModel>(); }
        }
